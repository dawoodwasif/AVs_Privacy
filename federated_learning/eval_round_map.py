...
config_path = os.path.join(curr_config_path, 'config.yaml')


if __name__ == '__main__':
    for num_round in [10, 20, 50, 100]:
        FedGH_model_name = f'model_weights/FedGH_{dataset_name}/FedGH_numlocalstep=1_numclient=4_numcomm=' + str(num_round-1) + '.pt'
        FedAvg_model_name = f'model_weights/FedAvg_{dataset_name}/FedAvg_numlocalstep=1_numclient=4_numcomm=' + str(num_round-1) + '.pt'
        FedMA_model_name = f'model_weights/FedMA_{dataset_name}/FedMA_numlocalstep=1_numclient=4_numcomm=' + str(num_round-1) + '.pt'
        FedProx_model_name = f'model_weights/FedProx_{dataset_name}/FedProx_numlocalstep=1_numclient=4_numcomm=' + str(num_round-1) + '.pt'
        CHFL_model_name = f'model_weights/CHFL_{dataset_name}/CHFL_numlocalstep=1_numclient=4_numcomm=' + str(num_round-1) + '.pt'
